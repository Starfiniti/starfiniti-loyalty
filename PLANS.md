...
M07-S01 through S03 are exact-head green on draft PR #32. Strict canonical-fact audiences, immutable database-timed snapshots, seven closed campaign behaviors, explicit-instant/IANA schedules, exact budgets and decimal RPC values, private approval-bound salted-hash control assignment, atomic campaign capacity, deterministic multiplier/bonus execution, and exactly-once campaign-attributed ledger evidence passed runs `31773939480`, `31777177961`, and `32662380030`. The latest passed the complete repository gate, both images, a clean 44-migration/38-pgTAP replay with 1,914 assertions including 62 focused capacity assertions, all four concurrency probes, 126 dashboard tests, 22 worker tests, 160 contract tests, 57 domain tests, 17 ADRs, and all four WooCommerce runtimes. M07-S04 canonical non-purchase trigger, fulfilment, refund, and cancellation execution is active; no campaign schedule or value is live yet.
...
1. M07: implement canonical milestone, win-back, tier, referral, limited-quantity fulfilment, refund, and cancellation execution in S04 on the exact-green S01–S03 authority.
