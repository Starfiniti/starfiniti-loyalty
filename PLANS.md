...
1. M11: implement explicit verified cross-workspace customer linking while S01 waits only for disabled deployment, Starfiniti canary, reconciliation, rollback, and observation.
