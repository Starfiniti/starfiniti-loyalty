...
adds the existing Analytics route to persistent navigation. The prior local
gate passed with 1,001 tests and both builds; exact-head checks and the current
solo adversarial review remain before closure.
