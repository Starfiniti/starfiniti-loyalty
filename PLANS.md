...
M06-S01 through S03 are exact-head green on draft PR #31. Runs `31763563259`, `31764805380`, and `31766887239` passed strict policy, opaque Auth-linked identity, signed offline capture, first attribution, historical qualification/cooling, and atomic two-sided exactly-once issuance/compensation. The latest passed a clean 39-migration/1,635-assertion replay, all three concurrency probes, both images, baseline, and all four WooCommerce runtimes. M06-S04 reversible fraud review is active.
