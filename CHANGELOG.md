...
- Added atomic campaign effect/points/liability counters, deterministic fixed-bonus and highest-priority multiplier evaluation, one-transaction programme and campaign-attributed ledger commits, immutable exact-retry context, and a two-session last-budget reservation probe. Non-purchase scheduling and managed rollout remain disabled until M07-S04.
