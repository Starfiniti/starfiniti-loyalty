...
That result predates the rollback-artifact extension and remains historical candidate-package evidence only. Rollback-aware implementation head `ed5eb7f315e2136d43d1f5a0b4cbdb75941b1c26` subsequently passed Security run `33151832310`, recovery-transport job `98785369076`. Artifact `9678028203` is GitHub-digested at `e1c29eaa9df6c8b04f8fad0de072ed71c30a9337d1c4ae648b60cb71bf2c63e5`; its independently hashed report is `a35f4dbd8bd892f41718fb639022350084ee67e535919558393c0d98ce4320d3`. The minimized report binds all three rollback name/version/hash facts, signed-metadata and exact-URL verification, zero retained package bytes, protocol 32, a two-file/21-byte transfer, no production mutation, and passing teardown.
