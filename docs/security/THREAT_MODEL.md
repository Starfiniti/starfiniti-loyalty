...
| ----- | ----------------------------------------------------------------- | -------- | --------------------------------------------------------------------------------------------------- | ---------------------------------------------------- | ------------------- |
| T-001 | Cross-tenant read/write through forged IDs or missing filter      | Critical | Composite tenant FKs, explicit grants, forced RLS, live membership helpers, no owner runtime        | Two-tenant pgTAP/API tests; forged org/object matrix | Phase 3             |
