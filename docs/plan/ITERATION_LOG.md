...
- Read-only facts currently show Debian 13.5 with Proxmox `9.2.3/d0fde103346cf89a`, rsync `3.4.1+ds1-5+deb13u3`, BorgBackup `1.4.0-5`, and OpenSSH `1:10.0p1-7+deb13u4` on the host; VM 971 is Ubuntu 24.04.4 with rsync `3.2.7-1ubuntu1.5` and OpenSSH `1:9.6p1-3ubuntu13.18`. No package, service, route, backup, database, checkout path, or loyalty value changed. A minimized clean-commit artifact and exact-head CI remain pending.
