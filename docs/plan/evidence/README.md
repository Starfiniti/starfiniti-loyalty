...
Scoring uses `docs/plan/evaluations/product-score.json` for whole-product readiness and a module-local 100-point score across correctness, security/tenancy/privacy, value reliability, tests, performance, operability, and maintainability. Completion requires at least 90/100, at least 80% in every relevant category, and no automatic failure.
