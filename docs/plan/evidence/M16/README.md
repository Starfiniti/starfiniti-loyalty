...
integration candidate at 83/100. The 2026-08-31 material-change rescore binds
code head `7fb4403`, including the M14 managed-session and mixed V1/V2 usage
recovery repair, the digest-pinned k6 boundary, ADR-0105's verified WooCommerce
release-integrity correction, and M09's production-rendered authentication
correction. M09 remains 88/100, M14 remains provisional 90/100, and the
whole-product candidate remains 83/100 because no tag, live capacity, fault,
recovery, activation, provider canary, deployment, rollback, observation, or
reconciliation evidence was added. The ranked backlog remains fourteen items and
now reflects the exact 3.60 TB recovery-transfer incident without changing its
gate state or score. Code head `7fb4403` passed CI `33434852244` and Security
`33434852266`; evidence head `6097056` passed CI `33435854855`, Security
`33435854858`, and external CodeQL with all twelve PR checks green and PR #57
merge-clean.
