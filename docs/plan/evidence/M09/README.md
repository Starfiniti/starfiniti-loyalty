...
- Authentication regression: [the exact-source Chrome report](login-responsive-browser-qa-2026-08-29.md) records the correction of a cramped mobile company-SSO row and an unreachable tall-card tail. The production bundle passed 1512 × 982, 390 × 844, and 320 × 500 checks with full-width narrow controls, reachable final guidance, keyboard traversal to the last SSO action, a same-origin protected-route redirect, English-only output, zero horizontal overflow, and zero browser diagnostics.
...
- Canary-baseline exact-head CI: [run 33100009132](https://github.com/Starfiniti/starfiniti-loyalty/actions/runs/33100009132) and [Security run 33100009100](https://github.com/Starfiniti/starfiniti-loyalty/actions/runs/33100009100) passed candidate `c989229d84a08a9d377b23c747219661fbb74a31` across all eleven checks. That identity remains unchanged because the immutable read-only production artifact is bound to it.
- Later material-change rescore: [run 33276262061](https://github.com/Starfiniti/starfiniti-loyalty/actions/runs/33276262061), [Security run 33276262148](https://github.com/Starfiniti/starfiniti-loyalty/actions/runs/33276262148), and [external CodeQL check 99163614374](https://github.com/Starfiniti/starfiniti-loyalty/runs/99163614374) passed exact integrated candidate `1e55a82a8f2feccdf3f55ace6a66e04b2595c7b0` across all twelve checks. The gate covers 995 workspace tests, 87 migrations, 69 pgTAP files with 3,790 assertions, all 22 concurrency probes, both production images, every WooCommerce runtime, DAST, supply chain, and recovery transport. This append-only rescore does not relabel the earlier canary baseline.
