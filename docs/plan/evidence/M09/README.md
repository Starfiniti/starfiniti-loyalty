...
- Compatibility: the server requests V5 first and normalizes V4/V3/V2/V1 only for recognized missing-function errors. Malformed, duplicate, oversized, contradictory, non-English, or provider-error data fails closed. Legacy fixed/percentage/shipping rewards remain conservative, expose no invented monetary/schedule evidence, and discard stored value.
...
- Compatibility: the server requests V6 first and normalizes V5/V4/V3/V2/V1 only for recognized missing-function errors. Malformed, contradictory, oversized, duplicate, non-English, or provider-error V6 data fails closed and never selects older referral facts.
