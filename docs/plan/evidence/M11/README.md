...
Status: M11-S01 implementation in progress on `codex/m11-multistore`; container replay, exact-head CI, adversarial concurrency, browser evidence, and production canary remain open.
...
- Clean container replay and all 52 new pgTAP assertions.
- Two-session same-group expected-revision race.
...
- Exact-head repository, image, WooCommerce, secret, audit, and licence gates.
