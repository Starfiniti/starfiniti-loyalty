...
begin
  ...
  select pg_catalog.jsonb_build_object(
    ...
    'capacity', pg_catalog.jsonb_build_object(
      ...
      'reservedEffects', pg_catalog.coalesce(counter.reserved_effects, 0)::text,
      'committedEffects', pg_catalog.coalesce(counter.committed_effects, 0)::text,
      'reservedPoints', pg_catalog.coalesce(counter.reserved_points, 0)::text,
      'committedPoints', pg_catalog.coalesce(counter.committed_points, 0)::text,
      'reservedLiabilityMinor',
        pg_catalog.coalesce(counter.reserved_liability_minor, 0)::text,
      'committedLiabilityMinor',
        pg_catalog.coalesce(counter.committed_liability_minor, 0)::text
    ),
    'purchaseOutcomes', pg_catalog.jsonb_build_object(
      'awarded', pg_catalog.coalesce(purchase.awarded, 0)::text,
      'control', pg_catalog.coalesce(purchase.control_count, 0)::text,
      'capacityExhausted',
        pg_catalog.coalesce(purchase.capacity_exhausted, 0)::text,
      'suppressed', pg_catalog.coalesce(purchase.suppressed, 0)::text,
      'reversedAwards',
        pg_catalog.coalesce(purchase.reversed_awards, 0)::text
    ),
    'triggerJobs', pg_catalog.jsonb_build_object(
      'pending', pg_catalog.coalesce(jobs.pending, 0)::text,
      'processing', pg_catalog.coalesce(jobs.processing, 0)::text,
      'retryable', pg_catalog.coalesce(jobs.retryable, 0)::text,
      'completed', pg_catalog.coalesce(jobs.completed, 0)::text,
      'cancelled', pg_catalog.coalesce(jobs.cancelled, 0)::text,
      'manualReview', pg_catalog.coalesce(jobs.manual_review, 0)::text
    ),
    'triggerOutcomes', pg_catalog.jsonb_build_object(
      'pointsAwarded', pg_catalog.coalesce(executions.points_awarded, 0)::text,
      'rewardReserved', pg_catalog.coalesce(executions.reward_reserved, 0)::text,
      'control', pg_catalog.coalesce(executions.control_count, 0)::text,
      'capacityExhausted',
        pg_catalog.coalesce(executions.capacity_exhausted, 0)::text,
      'pointsReversed', pg_catalog.coalesce(executions.points_reversed, 0)::text,
      'rewardCancellationRequested',
        pg_catalog.coalesce(executions.reward_cancellation_requested, 0)::text,
      'rewardAlreadyResolved',
        pg_catalog.coalesce(executions.reward_already_resolved, 0)::text,
      'rewardNonreversible',
        pg_catalog.coalesce(executions.reward_nonreversible, 0)::text,
      'noValueToReverse',
        pg_catalog.coalesce(executions.no_value_to_reverse, 0)::text
    ),
