    ...
    where namespace.nspname in ('public', 'loyalty')
      ...
      and not (
        ...
        and routine.proname in (
          ...
          'get_my_loyalty_experiences_v2',
          'get_my_loyalty_experiences_v3',
          ...
          'resolve_organization_federation_login_v2',
          'organization_scim_workspace_v1',
          ...
          'set_my_notification_preference_v1',
