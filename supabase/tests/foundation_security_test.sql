    ...
    where namespace.nspname in ('public', 'loyalty')
      ...
      and not (
        ...
        and routine.oid::regprocedure::text in (
          ...
          'loyalty.get_my_loyalty_experiences_v3()',
          ...
          'loyalty.get_my_managed_billing_usage_summary_v2(uuid,timestamp with time zone,timestamp with time zone)',
          ...
          'loyalty.resolve_organization_federation_login_v2(text)',
          'loyalty.organization_scim_workspace_v1(uuid)',
          'loyalty.create_organization_scim_endpoint_command_v1(uuid,uuid,text,bytea,text,uuid)',
          'loyalty.update_organization_scim_endpoint_command_v1(uuid,uuid,bigint,text,bytea,text,text,uuid)',
          'loyalty.map_organization_scim_group_role_command_v1(uuid,uuid,uuid,bigint,text,text,text,uuid)',
          'loyalty.claim_organization_scim_membership_v1(uuid,uuid)',
          'loyalty.create_organization_agency_invitation_command_v1(uuid,text,timestamp with time zone,text,text,uuid)',
          'loyalty.accept_organization_agency_invitation_command_v1(uuid,text,text,uuid)',
          'loyalty.revoke_organization_agency_relationship_command_v1(uuid,uuid,bigint,text,text,uuid)',
          'loyalty.get_organization_agency_portfolio_v1(uuid)',
          'loyalty.create_support_access_request_command_v1(uuid,uuid,text[],text,timestamp with time zone,text,uuid)',
          'loyalty.resolve_support_access_request_command_v1(uuid,uuid,bigint,text,text[],timestamp with time zone,text,text,uuid)',
          'loyalty.revoke_support_access_grant_command_v1(uuid,uuid,bigint,text,text,uuid)',
          'loyalty.get_support_administration_workspace_v1(uuid)',
          'loyalty.get_support_workspace_v1(uuid)',
          'loyalty.start_organization_break_glass_command_v1(uuid,text,text,uuid)',
          'loyalty.get_organization_recovery_workspace_v1(uuid)',
          'loyalty.get_organization_administration_export_v1(uuid,uuid)',
          'loyalty.organization_deletion_command_v1(uuid,uuid,uuid,bigint,text,text,text,uuid)',
          ...
          'loyalty.get_public_loyalty_experience_v5(uuid,uuid)',
          'loyalty.get_public_loyalty_experience_v6(uuid,uuid)',
