...
Scores are evidence-based and cover implementation through the Phase 9 initial-programme onboarding, customer-tier visibility, keyboard-bypass accessibility, sanitized support-diagnostics, and WooCommerce localization slices.
...
| Test strength                 |      15 |      15 | 100 unit tests, accessibility/i18n/package gates, 613 CI-passed pgTAP assertions, race/property probes, browser QA, and four WooCommerce runtimes                       |
