...
| Test strength                 |      15 |      15 | 999 workspace tests, 3,831 CI-passed pgTAP assertions, 22 concurrency probes, browser QA, and four WooCommerce runtimes                                                 |
...
The 2026-08-31 material-change rescore binds exact code head `7fb4403` after the M14 managed-session and usage recovery repair. All 89 migrations, 3,831 pgTAP assertions, 22 concurrency probes, both images, and all four WooCommerce runtime cells pass, but no live activation, provider canary, deployment, recovery, rollback, observation, or reconciliation evidence was added. M14 therefore remains provisional 90/100 with operability below its floor, the integration candidate remains 83/100, M16 remains 77/100, and deployed production remains 54/100.
