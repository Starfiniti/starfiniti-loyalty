...
Scores are evidence-based and cover implementation through the Phase 9 initial-programme onboarding, customer-tier visibility, keyboard-bypass accessibility, and sanitized support-diagnostics slices.
...
| Test strength                 |      15 |      15 | 95 unit tests, route-wide accessibility guard, PHP/static/package gates, 613 CI-passed pgTAP assertions, race/property probes, browser QA, and four WooCommerce runtimes |
