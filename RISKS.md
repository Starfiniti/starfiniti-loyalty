...
| R-008 | Declared WooCommerce compatibility exceeds executed release evidence  | High     | Extend the green minimum/current smoke to every release PHP, money, cache, and lifecycle case | Partially mitigated   |
